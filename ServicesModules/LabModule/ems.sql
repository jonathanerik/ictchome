...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2018 at 12:47 PM
...
CREATE TABLE `applied_leave` (
  ...
  `roccupy` varchar(1000) NOT NULL,
  `purpose` varchar(1000) NOT NULL,
  `rmail` varchar(255) NOT NULL,
...
INSERT INTO `applied_leave` (`id`, `rname`, `section`, `roccupy`, `purpose`, `rmail`, `pnumber`, `date_start`, `date_end`, `time_in`, `time_out`, `apply_by`, `status`, `comment`, `applied_date`) VALUES
(23, 'Rostom Danganan', 'IT3B', 'MB409', 'Meeting of the Field Sem for the arrival on May 2, 2018', 'jrdanaganan@gmail.com', '09981766256', '2018-12-31', 0, '12:59:00', '12:59:00', 10, 'Approved', '', '2018-05-19 10:37:59');
...
(10, 'arlan ariol', 'arlanariola09@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'Web Development', 'admin', '2018-05-03 20:46:51');
