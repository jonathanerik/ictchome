 ...
 <div class="collapse navbar-collapse" id="navbarSupportedContent">
   <ul class="navbar-nav">
	 ...
	 <li class="nav-item active">
       <a class="nav-link" href="coordinator.php">Home</a>
     </li>
	 
     <li class="nav-item active">
       <a class="nav-link" href="coordinator_notif.php">Notifications</a>
     </li>
     
     <li class="nav-item active">
       <a class="nav-link" href="coordinator_approval.php">Request/s Approval</a>
     </li>
