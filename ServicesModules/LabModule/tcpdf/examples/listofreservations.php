...
$pdf->Cell(0, 12, 'Reservations', 0, 1, 'L');
...
$tbl1 .= '<tr style="background-color:#000000;color:#FFFF00;"><td width="15">' . "" . '</td><td width="35">' . "Code" . '</td><td width="120">' . "Event Package" . '</td><td width="180">' . "Description" . '</td><td width="60">' . "Reservation Date" . '</td><td width="120">' . "Reserved By" . '</td></tr>';
...
while($row = mysql_fetch_array($result))
{
	 ...
	 $tbl .= '<tr><td width="15">' . $index . '</td><td width="35">' . $eventpackagescode . '</td><td width="120">' . $eventpackage . '</td><td width="180">' . $description . '</td><td width="60">' . $reservationdate . '</td><td width="120">' . $name . '</td></tr>';
}
