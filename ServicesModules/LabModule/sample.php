 ...
 <div class="collapse navbar-collapse" id="navbarSupportedContent">
   <ul class="navbar-nav">
     ...
     <li class="nav-item active">
       <a class="nav-link" href="schedules.php">Laboratory Schedules<span></span><span></span></a>
     </li>
     
     <li class="nav-item active">
       <a class="nav-link" href="leave.php">Request Form</a>
     </li>
     
     <li class="nav-item active">
       <a class="nav-link" href="applied-leave.php">View Request Submitted</a>
     </li>  
   </ul>
 </div>
</nav>
...
<option value="MB409">MB409</option>
</select> 
<br>
<br>
...
<br><b>Date of Occupy:</b> <br><input type="date" style = "text-align:center; font-family:Bookman Old Style; font-size:15px; font-weight:bold;" name="date" required/>
