...
<div class="main-body">
 ...
 <div class="collapse navbar-collapse" id="navbarSupportedContent">
   <ul class="navbar-nav">
     ...
     <li class="nav-item active">
       <a class="nav-link" href="requestform_superior.php">Request Form</a>
     </li>
     
     <li class="nav-item active">
       <a class="nav-link" href="requestapproval_superior.php">Request/s Approval</a>
     </li>  
   </ul>
 </div>
</nav>
...
<table class="table table-striped table-hover ">
  ...
  $query="Select * from applied_leave where status = 'Approved'";
	...
	}else
	{
      ...
      <td><?php echo $row['date_start']; ?><b> to </b><?php echo $row['date_end']; ?> <br>
	  <?php echo $row['time_in']; ?> <b> to </b> <?php echo $row['time_out']; ?>
	  </td>
