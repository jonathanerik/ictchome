 ...
 <div class="collapse navbar-collapse" id="navbarSupportedContent">
   <ul class="navbar-nav">
     ...
     <li class="nav-item active">
       <a class="nav-link" href="schedules.php">Add<span></span><span></span></a>
     </li>
     
     <li class="nav-item active">
       <a class="nav-link" href="leave.php">Edit</a>
     </li>
     
     <li class="nav-item active">
       <a class="nav-link" href="applied-leave.php">Delete</a>
     </li> 
...
<input  type="submit" name="submit" value="Search" style = "text-align:center; font-family:Bookman Old Style; font-size:15px; font-weight:bold;"> 
     </li>	 
	 </form>
   </ul>
 </div>
...
<table class="table table-striped table-hover ">
  ...
  <?php 
  $i=1;
  $query="Select * from applied_leave where status = 'Approved'";
	$res=mysqli_query($conn, $query);
	...
	}else
	{
	  ...
	  <?php echo $row['time_in']; ?> <b>-</b> <?php echo $row['time_out']; ?>
	  </td>
