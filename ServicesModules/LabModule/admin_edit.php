...
<table class="table table-striped table-hover ">
  ...
  <tbody>
  <?php 
  include_one('edit_action.php');
  if ( isset($_GET['edit'])
  {
	  $id = $_GET['edit'];
	  $res = mysql_query("SELECT * FROM applied_leave");
  }
  ?>
    <tr>
      
      
      <td><select name="roccupy" onBlur="checkeleavequan(this.value)">
<option value=""><?php echo $row['roccupy']; ?></option>
