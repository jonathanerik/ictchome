...
<div class="main-body">
	...
	<?php
		...
		{	
			...
			//edit
			echo "<a href='editing2.php?id={$row['id']}&&name=$name&&uname=$uname'> <img src='edit.png' width=24px style='margin-bottom:3px;margin-left:5px'> </a> </div>";
			}
			...
			echo "<div class='delete'>";
			//edit
			echo "<a href='process7.php?id={$row['id']}&&name=$name&&uname=$uname'> <img src='checked.png' width=24px style='margin-bottom:3px;margin-left:5px'> </a> </div>";
			}
			...
			echo "<a href='rview.php?id={$row['id']}&&name=$name&&uname=$uname'style='text-decoration:none;'>";
			echo "<div class='rows'>";
