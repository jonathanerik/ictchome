<?php
    ...
    {
        include 'connect.inc';
		$query="INSERT INTO requestdatabase (id, division, contact, date, comment, requestedby, username, status, note, technician) 
				VALUES('".$_POST["id"]."','".$_POST["division"]."','".$_POST["contact"]."','".$_POST["date"]."','".$_POST["comment"]."','".$_POST["requestedby"]."','".$_POST["username"]."','".$_POST["status"]."','".$_POST["note"]."','".$_POST["technician"]."')";
    ...
    <body  class="container-fluid" style="color: white; background-color: #344e35">
        <div class="col-12 mb-3 tableBorder">
            <div class="col-12 p-2">
                <h4 class="mb-1">Search Request </h4>     
                <form method="GET" action="ViewSearchReport.php" class="needs-validation" novalidate> 
                    <div class="row">
                        <div class="col-4 mb-1">
                            <label for="firstName">Please input the Request ID</label>
                            <input type="find" class="form-control" name="find" placeholder="Valid Request ID" required>
