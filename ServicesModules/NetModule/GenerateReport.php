...
<html lang="en">
    ...
    <body onload="myPrintFunction()" class="container-fluid" style="background-color: #344e35">
        <div class="container">
            <header class="blog-header py-3">
                <div class="flex-nowrap justify-content-between align-items-center">
                    <div class="col-12 pt-4 text-center">
                        ...
                        <h5 class="blog-header-logo text-dark" href="#">ICTC ONLINE<br>De La Salle Lipa</h5>
                    </div>
                </div>
                <div class="row flex-nowrap justify-content-between align-items-center">
                    <div class="col-4 pt-1">
                        <a class="text-muted" href="transactions.php">Menu</a>
                    </div>
                    <div class="col-4 d-flex justify-content-end align-items-center">
                        <a class="btn btn-sm btn-outline-secondary" href="#" onclick="myPrintFunction()">Generate Report</a>
                    </div>
                </div>
            </header>
                        ...
                        <table class="table table-hover" id="formtbl">
                            ...
                            <td>     
                                <?php
                                    ...
                                    {
                                        echo '<button type="button" class="btn-sm btn-outline-success" data-toggle="modal" data-target="#exampleModal' . $row['id'] . '">';   
                                        echo $row['status'];
                                        echo '</button>';
                                    }
                                    else
