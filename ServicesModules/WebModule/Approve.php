...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #1B1F1B;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
    	<ul class="navbar-nav">
    		...
    		<li class="nav-item active">
        		<a class="nav-link" href="Request.php">Request<span></span><span></span></a>
      		</li>

			<li class="nav-item active">
				<a class="nav-link" href="View.php">View Request</a>
			</li>
      
			<li class="nav-item active">
				<a class="nav-link" href="Approve.php">Approve Request</a>
			</li>
      	</ul>
	</div>
</nav>
