	...
	<table id="table_id" class="display">
	    ...
	    <tbody>
	        ...
	        <tr>
	            ...
	            <td><?php 
	            	if($request["approved_superior"] && $request["approved_ictc"])
	            	{
	            		echo $request["status"];
	            	}
	            	else if($request["approved_ictc"] && !$request["approved_superior"])
	            	{
	            		echo "For Approval of Superior";
	            	}
	            	else if(!$request["approved_ictc"] && $request["approved_superior"])
	            	{
	            		echo "For Approval of ICTC";
	            	}
	            	else
	            	{
	            		echo "For Approval of ICTC and Superior";
	            	}
	            	
	            ?></td>
	            <td><a href="request_details.php?id=<?php echo $request["id"]?>">Edit</a> <a href="request_delete.php?id=<?php echo $request["id"]?>">Delete</a></td>
	        </tr>
	        <?php } ?>
	    </tbody>
	</table>
