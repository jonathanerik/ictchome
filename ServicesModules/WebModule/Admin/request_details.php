	...
	<table border=3 width=500px height=100px>
		<form action="request_details_post.php?id=<?php echo $_GET['id']?>" method="POST">
			...
			<tr>
				...
				<td><input type="text" size="30" name="name" placeholder="Name" value="<?php echo $request['name']?>" /></td>
			</tr>
			<tr>
				<td><label>Employee Number:</label></td>
				<td><input type="text" size="30" name="stud_no" placeholder="Employee Number" value="<?php echo $request['stud_no']?>" /></td>
			</tr>
			<tr>
				<td><label>Email:</label></td>
				<td><input type="text" size="30" name="email" placeholder="Email" value="<?php echo $request['email']?>" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="date" name="request_date" value="<?php echo $request['request_date']?>" /></td>
			</tr>
			<tr>
				<td><label>Request:</label></td>
				<td><textarea rows='2' cols='30' name="request" value="<?php echo $request['request_message']?>" /<?php echo $request['request_message']?>></textarea></td>
			</tr>
			<tr>
				<td><label>Comments (ICTC):</label></td>
				<td><textarea rows='2' cols='30' name="comments_ictc" value="<?php echo $request['comments_ictc']?>" placeholder="Type your message or comments here."/><?php echo $request['comments_ictc']?></textarea></td>
			</tr>
			<tr>
				<td><label>Comments (Superior):</label></td>
				<td><textarea rows='2' cols='30' name="comments_superior" placeholder=""  value="<?php echo $request['comments_superior']?>"/><?php echo $request['comments_superior']?></textarea></td>
			</tr>	
			<tr>
			...
			<tr>
				<td><label>ICTC Approval:</label></td>
				<td><input type="checkbox" name="approval_ictc" <?php echo ($request["approved_ictc"]?"checked":"") ?>>
				</td>
			</tr>
			<tr>
				<td><label>Superior Approval:</label></td>
				<td><input type="checkbox" name="approval_superior" <?php echo ($request["approved_superior"]?"checked":"") ?>>
				</td>
			</tr>
			<tr>
				<td colspan='2'>
