	...
	<table border=3 width=500px height=100px>
		<form action="request_details_post.php?id=<?php echo $_GET['id']?>" method="POST">
			...
			<tr>
				...
				<td><textarea rows='2' cols='30' name="request" value="<?php echo $request['request_message']?>" disabled/></textarea></td>
			</tr><br>
			<tr>
				<td><label>Comments (ICTC):</label></td>
				<td><textarea rows='2' cols='30' name="comments" value="<?php echo $request['comments_ictc']?>" disabled/></textarea></td>
			</tr><br>
			<tr>
				<td><label>Comments (Superior):</label></td>
				<td><textarea rows='2' cols='30' name="comments" placeholder=""  value="<?php echo $request['comments_superior']?>" disabled/></textarea></td>
			</tr><br>
			<?php if(!$request['status_support']){?>	
			<tr>
				<td colspan='2'>
					<br>
						<center>
							
							<button type="submit" name="status" value="Update">Close Request</button>
