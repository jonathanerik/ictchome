...
<body>
	<div class="Header">
		<center>
		<img src="Template/images/DLSL-logo.png" class="logo" width="100px" height="100px">
...
<br>
	...
	<table border=3 width=500px height=100px>
		<form action="register_post.php" method="POST">
			<th colspan='2'><center>Web Support Registration Form</center></th>
			<tr>
				<td><label>Username:</label></td>
				<td><input type="text" size="30" name="username" placeholder="Username" required/></td>
			</tr>
			<tr>
				<td><label>Password:</label></td>
				<td><input type="password" size="30" name="password" placeholder="Password" required/></td>
			</tr>
			<tr>
				<td><label>Confirm Password:</label></td>
				<td><input type="password" size="30" name="confirm_password" placeholder="Confirm Password" required/></td>
			</tr>
			<tr>
				<td><label>Full Name:</label></td>
				<td><input type="text" size="30" name="fullname" placeholder="Full Name" required/></td>
			</tr>
			<tr>
				<td colspan='2'>
					<br>
