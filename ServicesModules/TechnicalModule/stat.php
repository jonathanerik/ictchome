   ...
   <ul class="navbar-nav">
     ...
     <li class="nav-item active">
	   ...
	   <?php
			...
			$query1="SELECT * FROM forms WHERE status='Completed'";
  ...
  $query="Select * from `forms`";
	...
	if($count>0)
	{
		  ...
		  <td><?php echo $row['contactnumber'];?></td>
			<td><?php echo $row['department'];?> </td>
			  <td><?php echo $row['building'];?></td>
				...
				<td><a class="btn btn-danger" name="Cancelled" href="stat.php?formid=<?php echo $row['formid']; ?>" onclick="return confirm('Are you Sure?');">Cancel</a>
		...
		if (isset($_GET['formid'])){
			...
			$delete= "DELETE FROM forms WHERE formid='$formid'";
			mysql_query($delete);
		}
	}
  ?>
