...
<?php
	...
	include 'dbconnect.inc';
			$query="INSERT INTO form1(fullname,email,date,contactnumber,department,building,roomnumber,issues,request,status)
	...
	$is_query_successful=mysql_query($query);
					...
					{
						echo '<script type="text/javascript"> alert("Request has been successfully submitted!"); window.location="status.php"; </script>';
