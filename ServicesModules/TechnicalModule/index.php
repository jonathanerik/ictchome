 ...
 <center><div class="collapse navbar-collapse" id="navbarSupportedContent">
   <ul class="navbar-nav">
    ...
    <li class="nav-item active">
     ...
     <li class="nav-item active">
       <a class="nav-link" href="DesignTemplate.html">FAQs <span></span><span></span></a>
     </li>
...
<p style="font-family:Agency FB;color:black;font-size:20px;line-height:120%;text-align:left; margin-left:500px">Username
<input style="color:green; border-color:green;text-align:left;margin-left:50px" type="text" name="username" placeholder="Enter Username">
</p>
</br>
<p style="font-family:Agency FB;color:black;font-size:20px;line-height:120%;text-align:left; margin-left:500px">Password
<input style="color:green; border-color:green;text-align:left;margin-left:52px" type="password" name="password" placeholder="Enter Password"></p></br>
