...
if(isset($_POST['Approved']))
{
	...
	$query_select="SELECT * FROM forms WHERE formid = '$formid'";
								...
								if(mysql_num_rows($result_query)>0)
								{
									...
									$query_apprv="UPDATE forms SET status ='Approved' , comment = '$comment' WHERE formid = '$formid'";
...
if(isset($_POST['Rejected']))
{
	...
	$query_select="SELECT * FROM forms WHERE formid = '$formid'";
								...
								if(mysql_num_rows($result_query)>0)
								{
									...
									$query_apprv="UPDATE forms SET status ='Rejected', comment = '$_POST[comment]' WHERE formid = '$formid'";
									$query_update_apprv=mysql_query($query_apprv);
								}
}
...
if(isset($_POST['Approved1']))
{
	...
	$query_select="SELECT * FROM form1 WHERE formsid = '$formid'";
								...
								if(mysql_num_rows($result_query)>0)
								{
									...
									$query_apprv="UPDATE form1 SET status ='Approved' , comment = '$_POST[comment]'WHERE formsid = '$formid'";
									$query_update_apprv=mysql_query($query_apprv);
								}
...
if(isset($_POST['Rejected1']))
{
	...
	$query_select="SELECT * FROM form1 WHERE formsid = '$formid'";
								...
								if(mysql_num_rows($result_query)>0)
								{
									...
									$query_apprv="UPDATE form1 SET status ='Rejected' , comment = '$_POST[comment]'WHERE formsid = '$formid'";
									$query_update_apprv=mysql_query($query_apprv);
								}
}
	  ...
	  <td><?php echo $row['contactnumber'];?></td>
	    <td><?php echo $row['department'];?> </td>
		  <td><?php echo $row['building'];?></td>
			...
			<form method="post" action="ICTC page.php" >
			<td><textarea name="comment" value="<?php echo $row['comment'];?>"></textarea></td>
