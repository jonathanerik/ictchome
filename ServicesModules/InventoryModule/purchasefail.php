...
<p style="font-family:Agency FB;font-size:20px;line-height:120%;text-align:center;margin-top:80px"><b>Record was unsuccessful. Pleae make sure that the details are complete!</p></b>

<a style="font-family:Agency FB;color:green;font-size:20px;line-height:120%;text-align:left;margin-top:80px;margin-left:180px" href="purchase.php"><p style="font-family:Agency FB;font-size:20px;color:black;line-height:80%;text-align:left;margin-top:20px;margin-left:420px"> Add another record</a></center></p>
