...
<p style="font-family:Agency FB;color:black;font-size:50px;line-height:120%;text-align:center">D E P L O Y &emsp; E Q U I P M E N T </p>



</br>
<form method="POST" action="deployequipment2.php">





<p style="font-family:Agency FB;color:black;font-size:20px;line-height:120%;text-align:left; margin-left:500px">Date Deployed
<input style="color:green; border-color:green;text-align:left;margin-left:28px" type="date" name="date" required></p>
...
<p style="font-family:Agency FB;color:black;font-size:20px;line-height:120%;text-align:left; margin-left:500px">Deployed by
<select style="color:green; border-color:green;text-align:left;margin-left:43px" name="deployer">
...
<input style="color:green; border-color:green;text-align:left;margin-left:62px" type="text" name="receiver" required></p>
