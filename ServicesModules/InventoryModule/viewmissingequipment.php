...
V I E W &emsp; M I S S I N G&emsp; E Q U I P M E N T


<a href="printmissingequipment.php">
...
$TotalRec = mysql_result(mysql_query("SELECT COUNT(*) FROM missing"), 0);

$select = "SELECT * FROM missing LIMIT $start, $perpage";
...
{
  echo '<a href='."./viewmissingequipment.php?id=" . ($start - $perpage) . '>'."Previous".'</a>';
}?>
...
{
  echo '<a href='."./viewmissingequipment.php?id=" . ($start + $perpage) . '>'."Next".'</a>';
}
