...
<a style="color:green;" href="generatereport.php"><p style="font-family:Agency FB;color:black;font-size:50px;line-height:120%;text-align:left;margin-left:220px;margin-top:0px"> << </a>
...
$TotalRec = mysql_result(mysql_query("SELECT COUNT(*) FROM forexchange"), 0);

$select = "SELECT * FROM forexchange LIMIT $start, $perpage";
...
{
  echo '<a href='."./viewforexchange.php?id=" . ($start - $perpage) . '>'."Previous".'</a>';
}?>
...
{
  echo '<a href='."./viewforexchange.php?id=" . ($start + $perpage) . '>'."Next".'</a>';
}
end:
?>
<style>
