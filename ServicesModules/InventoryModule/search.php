...
if($_POST['search']==$row['Tools'])
{
$counter=$counter+1;

?>
<p style="font-family:Agency FB;color:black;font-size:50px;line-height:120%;text-align:center">You searched for 
<?php
...
<p style="font-family:Agency FB;color:black;font-size:50px;line-height:120%;text-align:center">No item matched your search
</br></br>
<a href=inventory.php> Go back to Inventory </a></p>
<?php
goto end;
}
?>
...
$header=array('Serial Number','Tool','Status','Office');
for ($a=0;$a<1;$a++)
{
