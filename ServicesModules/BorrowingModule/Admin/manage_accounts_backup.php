						...
						if(isset($_POST['search']))
						{
							...
							if(mysqli_num_rows($result_search)>0)
							{
								...
								while($row=mysqli_fetch_array($result_search))
								{
									...
									echo "<td>".$gender."</td>";
									echo "<td>".date('d/m/Y', strtotime($bday))."</td>";
									echo "<td>".$cn."</td>";
									echo "<td>".$email."</td>";
									echo "<td>".$username."</td>";
									echo "<td>".$pw."</td>";
						...
						elseif(isset($_POST['edit']))
									{
										...
										?><table class="status_table" border=1>
											...
											{
												if($row['user_ID']==$userID_selected)
												{?>
													<form action="manage_accounts.php" method="POST">
														<tr>
															<td><?php echo $row['user_ID']?></td>
															<td><input type="text" name="fullname" value="<?php echo $row['fullname']?>"></td>
															<td><input type="text" name="gender" value="<?php echo $row['gender']?>" size="10px"></td>
															<td>
															<input style="width:130px" type="date" name="bday" value="<?php echo $row['birthday']?>" size="10px"></td>
															<td><input type="text" name="contact_num" value="<?php echo $row['contact_num']?>" size="12px"></td>
															<td><input type="text" name="email" value="<?php echo $row['email']?>" size="35px"></td>
															<td><input type="text" name="username" value="<?php echo $row['username']?>" size="10px"></td>
															<td><input type="text" name="password" value="<?php echo $row['password']?>" size="10px"></td>
															<td><input type="text" name="usertype" value="<?php echo $row['usertype']?>" size="10px"></td>
															<td colspan="2"><input type="submit" name="update" class="update_user_acct" value="Update User"></td>
															<?php
															if(isset($_POST['update']))
															{
																...
																$update_query1="UPDATE userinfotable SET fullname='$fullname', gender='$gender', birthday='$bday', contact_num='$cn', email='$email', username='$username', password='$pw', usertype='$usertype' WHERE user_ID = '$ID' ";
											...
											<form action="manage_accounts.php" method="POST">
												<tr>
													...
													if(isset($_POST['update']))
													{
														...
														$update_query2="UPDATE userinfotable SET fullname='$fullname', gender='$gender', birthday='$bday', contact_num='$cn', email='$email', username='$username', password='$pw', usertype='$usertype' WHERE user_ID = '$ID' ";
