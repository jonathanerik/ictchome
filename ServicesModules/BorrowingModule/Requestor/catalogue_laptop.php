<?php
	...
	if(mysqli_num_rows($result)>0)
	{
		...
		{
			if($row['equipment_name'] == 'Acer Aspire E-15 Laptop')
			{
				$_SESSION['a']=$row['equipment_name'];
			}
		}
	}
...
<body>
	...
	<div class="main-body">
		...
		<div class="Service">
			...
			<p class="Equipment_Name"><?php echo $_SESSION['a']?></p>
			...
			<div class="Equipment_Description">
				<?php
					...
					if(mysqli_num_rows($result)>0)
					{
						while($row=mysqli_fetch_assoc($result))
						{
							if ($row['equipment_name'] == $_SESSION['a'])
							{
			...
			<div class="Quantity">
				<form action="request_form_laptop.php" method="POST">
				  <b>Quantity:</b>
