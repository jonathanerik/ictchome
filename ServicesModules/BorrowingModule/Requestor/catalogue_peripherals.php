<?php
	...
	if(mysqli_num_rows($result)>0)
	{
		...
		{
			if ($row['equipment_name'] == 'A4tech Mouse and Keyboard'){
				$c=$row['equipment_name'];
			}
		}
	}
?>
...
<body>
	...
	<div class="main-body">
		...
		<div class="Service">
			...
			<p class="Equipment_Name"><?php echo $c?></p>
			...
			<div class="Availability">Availability: <?php echo $quantity_onhand ?>/<?php echo $quantity ?> <!--from database--></div>
			<div class="Quantity">
				<form action="request_form_peripherals.php" method="POST">
				  <b>Quantity:</b>
