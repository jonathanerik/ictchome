...
<body>
	...
	<div class="main-body">
		...
		<div class="Service">
			...
			<button class="back" onclick="location='catalogue_peripherals.php'"/>◄ Back</button>
<br>
	<table class="request_form" border=1>
		<form action="#" method="POST">
			...
			<tr>
				...
				<td><input type="text" name="name" value="<?php echo $_SESSION['fullname']; ?>" size="23"/></td>
			</tr>
			<tr>
				<td><label>Request Date:</label></td>
				<td><input type="date" name="date_rqstd" required/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="name" value="<?php echo $c; ?>" size="26"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="name" value="<?php echo $quantity; ?>"/></td>
			</tr>
			<tr>
				<td><label>Purpose:</label></td>
				<td><textarea rows='2' cols='30' name="purpose" placeholder="Write your purpose here!!!" required/></textarea></td>
			</tr>
			<tr>
