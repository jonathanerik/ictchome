...
<body>
	...
	<div class="main-body">
		...
		<div class="Containter">
			<div class="wrapper">
				<div class="one">
					<a href="view_catalogue.php"><img src="css/images/catalog_icon.png" height="30px"><br>View Catalog</a>
				</div>
				<div class="two">
					<a href="view_status.php"><img src="css/images/status_icon.png" height="35px"><br>View Request Status</a>
				</div>
			</div>
		</div>
	</div>
