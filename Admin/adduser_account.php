		...
		<div class="Service">
			...
			<table class="status_table" border=1>
				<th colspan='14'><center>User Information</center></th>
					<form action="adduser_account.php" method="POST">
						<tr>
						...
						<tr>
							...
							<td><input type="date" name="bday" placeholder="Birthday" required></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="radio" name="usertype" value="ICTC_Admin" checked required/>ICTC Admin
								<input type="radio" name="usertype" value="ICTC_Approver" required/>ICTC Approver
								<input type="radio" name="usertype" value="ICTC_Superior" required/>ICTC Superior
								<input type="radio" name="usertype" value="Requestor" required/>Requestor
							</td>
						</tr>
						<tr>
							<td colspan="2"><input type="submit" name="add" value="Add User Account"></td>
							<?php
								if(isset($_POST['add']))
								{
									...
									$check_query="SELECT * FROM userinfotable WHERE username='$username' AND password='$password'";
									...
									if(mysqli_num_rows($check_result)>0)
									{
										...
										?><meta http-equiv="refresh" content=".000001;url=adduser_account.php"/><?php
									}
									else
									{
										$insert_query="INSERT INTO userinfotable VALUES ('','$fullname','$gender','$bday','$cn','$email','$username','$pw','$usertype')";
										...
										if($result_query)
										{
											...
											?><meta http-equiv="refresh" content=".000001;url=manage_accounts.php"/><?php
										}
										else
										{
